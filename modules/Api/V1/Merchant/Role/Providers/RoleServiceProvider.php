...
namespace Modules\Api\V1\Merchant\Role\Providers;

use Illuminate\Support\ServiceProvider;

use Modules\Api\V1\Merchant\Role\Repositories\RoleRepository;
...
class RoleServiceProvider extends ServiceProvider
{
    ...
    protected function registerViews(): void
    {
        ...
        if (is_dir($path)) {
            $this->loadViewsFrom($path, 'merchant/role');
        }
    }
    ...
    protected function registerConfig(): void
    {
        ...
        if (file_exists($path)) {
            $this->mergeConfigFrom($path, 'modules.api.v1.merchant.role');
        }
    }
}
