    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-5 pb-5 dark:border-gray-800 dark:bg-white/[0.03] sm:pt-6">
        ...
        <div class="flex items-center gap-3 mb-5 px-5 sm:px-6">
            ...
            <div class="relative w-64">
                ...
                <input type="text" placeholder="Search by brand name" class="w-full rounded-lg border border-gray-200 bg-white pl-10 pr-4 py-2 text-sm text-gray-700 placeholder-gray-400 outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-white/[0.03] dark:text-gray-300 dark:placeholder-gray-500" />
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-emerald-500 text-white text-sm">
                            ...
                            <th class="px-4 py-3 text-left font-medium w-[25%]">Brand Name</th>
                            <th class="px-4 py-3 text-center font-medium w-[12%]">Products</th>
                            <th class="px-4 py-3 text-center font-medium w-[10%]">Status</th>
                            <th class="px-4 py-3 text-left font-medium w-[15%] whitespace-nowrap">Created Date</th>
                ...
                <div class="max-h-[650px] overflow-y-auto custom-scrollbar">
                    <table class="w-full">
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @php
                                $brands = [
                                    ['name' => 'Samsung', 'slug' => 'samsung', 'products' => 3420, 'status' => 'Active', 'created_at' => '15/01/2025 10:30 AM'],
                                    ['name' => 'Apple', 'slug' => 'apple', 'products' => 2180, 'status' => 'Active', 'created_at' => '15/01/2025 10:35 AM'],
                                    ['name' => 'Xiaomi', 'slug' => 'xiaomi', 'products' => 4650, 'status' => 'Active', 'created_at' => '16/01/2025 09:15 AM'],
                                    ['name' => 'Realme', 'slug' => 'realme', 'products' => 1890, 'status' => 'Active', 'created_at' => '16/01/2025 09:20 AM'],
                                    ['name' => 'Sony', 'slug' => 'sony', 'products' => 1250, 'status' => 'Active', 'created_at' => '17/01/2025 11:00 AM'],
                                    ['name' => 'JBL', 'slug' => 'jbl', 'products' => 980, 'status' => 'Active', 'created_at' => '18/01/2025 02:45 PM'],
                                    ['name' => 'Recci', 'slug' => 'recci', 'products' => 540, 'status' => 'Active', 'created_at' => '19/01/2025 10:10 AM'],
                                    ['name' => 'Baseus', 'slug' => 'baseus', 'products' => 870, 'status' => 'Active', 'created_at' => '20/01/2025 03:25 PM'],
                                    ['name' => 'Anker', 'slug' => 'anker', 'products' => 620, 'status' => 'Active', 'created_at' => '22/01/2025 11:40 AM'],
                                    ['name' => 'No Brand', 'slug' => 'no-brand', 'products' => 18450, 'status' => 'Active', 'created_at' => '15/01/2025 10:00 AM'],
                                    ['name' => 'TestBrand', 'slug' => 'testbrand', 'products' => 0, 'status' => 'Inactive', 'created_at' => '01/04/2026 09:00 AM'],
                                ];
                            @endphp
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td class="px-4 py-4 w-[8%]">
                                        <div class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center overflow-hidden">
                                            <span class="text-sm font-bold text-gray-400 dark:text-gray-500">{{ strtoupper(substr($brand['name'], 0, 2)) }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 w-[25%]">
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800 dark:text-white/90">{{ $brand['name'] }}</p>
                                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{{ $brand['slug'] }}</p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-center w-[12%]">
                                        <span class="text-sm font-medium {{ $brand['products'] === 0 ? 'text-gray-400 dark:text-gray-500' : 'text-gray-800 dark:text-white/90' }}">{{ number_format($brand['products']) }}</span>
                                    </td>
                                    <td class="px-4 py-4 text-center w-[10%]">
                                        <span class="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium
                                            {{ $brand['status'] === 'Active' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30' : 'bg-gray-100 text-gray-500 border border-gray-200 dark:bg-gray-500/10 dark:text-gray-400 dark:border-gray-500/30' }}
                                        ">
                                            <span class="w-1.5 h-1.5 rounded-full {{ $brand['status'] === 'Active' ? 'bg-emerald-500' : 'bg-gray-400' }}"></span>
                                            {{ $brand['status'] }}
                                        </span>
                                    </td>
                                    <td class="px-4 py-4 w-[15%]">
                                        @php $dp = explode(' ', $brand['created_at'], 2); @endphp
                                        <div>
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-5 sm:px-6 pt-4 pb-2 border-t border-gray-200 dark:border-gray-800">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Showing <span class="font-medium text-gray-700 dark:text-gray-300">1</span> to <span class="font-medium text-gray-700 dark:text-gray-300">11</span> of <span class="font-medium text-gray-700 dark:text-gray-300">248</span> results
            </p>
