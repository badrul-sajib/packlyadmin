...
@section('content')
    <x-common.page-breadcrumb pageTitle="All Product List" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-5 pb-5 dark:border-gray-800 dark:bg-white/[0.03] sm:pt-6">
                ...
                <div class="max-h-[650px] overflow-y-auto custom-scrollbar">
                    <table class="w-full">
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @php
                                $products = [
                                    ['name' => '3D Creative Visualization LED Lamp with Calendar Design Night Light for Home Office', 'image' => null, 'merchant' => 'Home Shop BD.com', 'phone' => '01910903717', 'status' => 'Pending', 'sku' => 'TSWFA1LP', 'category' => 'Electronic Accessories', 'price' => '599.00', 'discount' => '499.00', 'variant' => 'Single', 'stock' => 6],
                                    ['name' => 'Spider Man Only Cover Airpods Pro and Pro 2nd Gen Premium Earbuds Protective Cover Spider Man airpod pro Full Original soft silicon case', 'image' => null, 'merchant' => 'LUXURY VIP', 'phone' => '01342584477', 'status' => 'Pending', 'sku' => '6GIA0XDZ', 'category' => 'Electronics Device', 'price' => '400.00', 'discount' => '150.00', 'variant' => 'Single', 'stock' => 100],
                                    ['name' => 'Recci Risk W30 Transparent RGB Bluetooth Speaker', 'image' => null, 'merchant' => 'WKL Marts', 'phone' => '01781951811', 'status' => 'Pending', 'sku' => 'I8FV8AJY', 'category' => 'Electronics Device', 'price' => '750.00', 'discount' => '690.00', 'variant' => 'Single', 'stock' => 1],
                                    ['name' => 'SHAHRIAR RAHMAN', 'image' => null, 'merchant' => 'CarbonX Shop', 'phone' => '01775006663', 'status' => 'Pending', 'sku' => 'VXDCVX', 'category' => 'Electronics Device', 'price' => '123.00', 'discount' => '123.00', 'variant' => 'Single', 'stock' => 122],
                                    ['name' => 'Only Cover Airpods Pro and Pro 2nd Gen Premium Earbuds Protective Cover Pikachu airpod pro Full Original soft silicon case', 'image' => null, 'merchant' => 'LUXURY VIP', 'phone' => '01342584477', 'status' => 'Pending', 'sku' => 'UMV3C1MC', 'category' => 'Electronics Device', 'price' => '400.00', 'discount' => '150.00', 'variant' => 'Single', 'stock' => 100],
                                    ['name' => 'Only Cover Airpods Pro and Pro 2nd Gen Premium Earbuds Protective Cover French Bulldog airpod pro Full Original soft silicon case', 'image' => null, 'merchant' => 'LUXURY VIP', 'phone' => '01342584477', 'status' => 'Pending', 'sku' => 'JAKWLSPL', 'category' => 'Electronics Device', 'price' => '400.00', 'discount' => '160.00', 'variant' => 'Single', 'stock' => 100],
                                ];
                            @endphp
                                    ...
                                    <td class="px-4 py-4 text-center w-[8%]">
                                        @php
                                            $statusStyles = [
                                                ...
                                                'Approved' => 'bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30',
                                                'Rejected' => 'bg-red-50 text-red-700 border border-red-200 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/30',
                                            ];
                                            $dotColors = [
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium {{ $statusStyles[$product['status']] ?? '' }}">
                                            <span class="w-1.5 h-1.5 rounded-full {{ $dotColors[$product['status']] ?? 'bg-gray-400' }}"></span>
                                            {{ $product['status'] }}
                                        </span>
                                    </td>
                                    {{-- SKU --}}
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-5 sm:px-6 pt-4 pb-2 border-t border-gray-200 dark:border-gray-800">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Showing <span class="font-medium text-gray-700 dark:text-gray-300">1</span> to <span class="font-medium text-gray-700 dark:text-gray-300">6</span> of <span class="font-medium text-gray-700 dark:text-gray-300">44,856</span> results
            </p>
            <nav class="flex items-center gap-1">
                ...
                <button type="button" class="inline-flex items-center justify-center w-9 h-9 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/[0.05]">4,486</button>
