...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    protected function setBaseUrl()
    {
        if (app()->environment('production')) {
            $this->baseUri = 'https://admin.shop.packly.com';
        } else {
    ...
    {
        $this->successUrl = rtrim($this->baseUri, '/').$this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim($this->baseUri, '/').$this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = rtrim($this->baseUri, '/').$this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim($this->baseUri, '/').$this->config['ipn_url'];
    }
